...
# Accessing an employee via the class method.
# The class method full_name needs a specific instance to 
# invoked correctly.
print("Employee details by invoking class method with instance reference/self:")
